...
<template>
    ...
    <div class="flex min-h-svh flex-col items-center justify-center bg-background p-6 text-center">
        <p class="text-sm font-semibold uppercase tracking-widest text-muted-foreground">403</p>
        <h1 class="mt-3 text-3xl font-bold tracking-tight">Access denied</h1>
        <p class="mt-3 max-w-sm text-muted-foreground">
            You don't have permission to view this page. If you believe this is a mistake, contact support.
        </p>
