        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6 max-w-3xl">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="space-y-2">
                    ...
                    <p class="text-sm text-muted-foreground md:text-base">
                        View your profile and professional information
                    </p>
                    <PageHelp storage-key="provider-profile" :steps="['A complete profile makes you more visible and trustworthy to shops.', 'Add your bio, skills, and years of experience so shops know what you bring.', 'Set up your payout account via Stripe to receive earnings — takes a few minutes and stays right in the app.', 'Once your payout account is connected and your profile is active, you can accept bookings and earn.']" />
                </div>
            ...
            <template v-else>
                ...
                <Card>
                    ...
                    <CardFooter>
                        <Link href="/provider/profile/edit" class="w-full">
