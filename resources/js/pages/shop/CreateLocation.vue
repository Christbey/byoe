        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6 max-w-2xl">
            ...
            <div class="space-y-2">
                ...
                <p class="text-sm text-muted-foreground md:text-base">
                    Add a new shop location for service requests
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the address for your shop location. We'll
                        automatically geocode it to match you with nearby
                        providers.
                    </CardDescription>
                </CardHeader>
                <CardContent>
